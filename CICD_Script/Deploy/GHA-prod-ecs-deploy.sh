...
sed -i "s|~APPNAME~|${cdAppName}|g" $workspace/CICD_Script/Deploy/prod-create-deployment.json
sed -i "s|~DEPGROUPNAME~|${cdGroupName}|g" $workspace/CICD_Script/Deploy/prod-create-deployment.json
sed -i "s|~TASK_DEFINATION~|${taskFamily}|g" $workspace/CICD_Script/Deploy/prod-create-deployment.json
sed -i "s|~BUILD_NUMBER~|${newRevision}|g" $workspace/CICD_Script/Deploy/prod-create-deployment.json
...
--cli-input-json file://$workspace/CICD_Script/Deploy/prod-create-deployment.json \
